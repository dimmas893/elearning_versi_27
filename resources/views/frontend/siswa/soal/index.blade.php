                                        ...
                                        <div class="row">
                                            <div class="col">
                                                    ...
                                                    {{-- @foreach($hasil_soal as $p) --}}
                                                        ...
                                                        <p class="text-center">
                                                            <h4 class="text-center" style="color: rgb(3, 235, 53)">
                                                                @if($hasil_soal->total_soal == 40)
                                                                        nilai anda = {{ $hasil_soal->nilai * 2.5 }}
                                                                    @endif


                                                                    @if($hasil_soal->total_soal == 20)
                                                                        nilai anda = {{ $hasil_soal->nilai * 5 }}
                                                                    @endif


                                                                    @if($hasil_soal->total_soal == 10)
                                                                            nilai anda = {{ $hasil_soal->nilai * 10 }}
                                                                @endif
                                                            </h4>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-center">jawaban benar = {{ $hasil_soal->nilai }} soal</p>
                                                    <p class="text-center">jawaban salah = {{ $hasil_soal->total_soal - $hasil_soal->nilai }} soal</p>
                                                    
                                                    <div class="text-center">
                                                        <td><a href="/soal/semester/siswa/{{encrypt($mata_pelajaran->id)}}/{{encrypt($category_soal->id)}}" class="btn btn-success">kembali</a></td>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
